function rmse = Practica2(kf)
    ...
    %hay que recortarla para que inicie en el punto máximo y no en 0 y 
    ...
    l = 0.295; %longitud del eje al centro de masa
    g = 9.81; %gravedad
    %kf = 0.07839;
    ...
    rmse = sqrt(mean((theta_r - theta1(1:1091)).^2));
    
    plot((bd.time(1:length(theta_r)))*(bd.promt), theta_r, 'DisplayName','Experimentales')
